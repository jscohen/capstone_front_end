...
define('capstone_front_end/tests/components/edit-doc.jshint.lint-test', [], function () {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'components/edit-doc.js should pass jshint.\ncomponents/edit-doc.js: line 3, col 39, Missing semicolon.\ncomponents/edit-doc.js: line 4, col 36, Missing semicolon.\ncomponents/edit-doc.js: line 15, col 29, Missing semicolon.\ncomponents/edit-doc.js: line 18, col 33, Missing semicolon.\ncomponents/edit-doc.js: line 24, col 43, Missing semicolon.\ncomponents/edit-doc.js: line 25, col 42, Missing semicolon.\ncomponents/edit-doc.js: line 26, col 45, Missing semicolon.\ncomponents/edit-doc.js: line 29, col 59, Missing semicolon.\ncomponents/edit-doc.js: line 30, col 55, Missing semicolon.\ncomponents/edit-doc.js: line 31, col 28, Missing semicolon.\ncomponents/edit-doc.js: line 32, col 25, Missing semicolon.\ncomponents/edit-doc.js: line 33, col 42, Missing semicolon.\ncomponents/edit-doc.js: line 34, col 22, Missing semicolon.\ncomponents/edit-doc.js: line 36, col 28, Missing semicolon.\ncomponents/edit-doc.js: line 38, col 58, Missing semicolon.\ncomponents/edit-doc.js: line 41, col 26, Missing semicolon.\ncomponents/edit-doc.js: line 43, col 54, Missing semicolon.\ncomponents/edit-doc.js: line 45, col 69, Missing semicolon.\ncomponents/edit-doc.js: line 19, col 28, \'$\' is not defined.\ncomponents/edit-doc.js: line 23, col 19, \'$\' is not defined.\ncomponents/edit-doc.js: line 24, col 19, \'$\' is not defined.\ncomponents/edit-doc.js: line 25, col 19, \'$\' is not defined.\ncomponents/edit-doc.js: line 29, col 20, \'$\' is not defined.\ncomponents/edit-doc.js: line 30, col 18, \'$\' is not defined.\ncomponents/edit-doc.js: line 33, col 18, \'$\' is not defined.\ncomponents/edit-doc.js: line 2, col 10, \'storageFor\' is defined but never used.\ncomponents/edit-doc.js: line 3, col 8, \'storage\' is defined but never used.\ncomponents/edit-doc.js: line 4, col 8, \'Docs\' is defined but never used.\n\n28 errors');
  });
});
...
define('capstone_front_end/tests/helpers/module-for-acceptance', ['exports', 'qunit', 'capstone_front_end/tests/helpers/start-app', 'capstone_front_end/tests/helpers/destroy-app'], function (exports, _qunit, _capstone_front_endTestsHelpersStartApp, _capstone_front_endTestsHelpersDestroyApp) {
  exports['default'] = function (name) {
    var options = arguments.length <= 1 || arguments[1] === undefined ? {} : arguments[1];

    (0, _qunit.module)(name, {
      beforeEach: function beforeEach() {
        this.application = (0, _capstone_front_endTestsHelpersStartApp['default'])();
      ...
      afterEach: function afterEach() {
        ...
        (0, _capstone_front_endTestsHelpersDestroyApp['default'])(this.application);
      }
    });
  };
});
...
define('capstone_front_end/tests/helpers/resolver', ['exports', 'capstone_front_end/resolver', 'capstone_front_end/config/environment'], function (exports, _capstone_front_endResolver, _capstone_front_endConfigEnvironment) {

  var resolver = _capstone_front_endResolver['default'].create();
...
define('capstone_front_end/tests/helpers/start-app', ['exports', 'ember', 'capstone_front_end/app', 'capstone_front_end/config/environment'], function (exports, _ember, _capstone_front_endApp, _capstone_front_endConfigEnvironment) {
  exports['default'] = startApp;

  function startApp(attrs) {
    var application = undefined;

    var attributes = _ember['default'].merge({}, _capstone_front_endConfigEnvironment['default'].APP);
    attributes = _ember['default'].merge(attributes, attrs); // use defaults, but you can override;

    _ember['default'].run(function () {
      application = _capstone_front_endApp['default'].create(attributes);
...
define('capstone_front_end/tests/integration/components/add-doc-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {
  ...
  (0, _emberQunit.test)('it renders', function (assert) {
    ...
    this.render(Ember.HTMLBars.template({
      'id': '02Zdtl30',
      'block': '{"statements":[["append",["unknown",["add-doc"]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
      'meta': {}
    }));
    ...
    this.render(Ember.HTMLBars.template({
      'id': '8YyT5qSB',
      'block': '{"statements":[["text","\\n"],["block",["add-doc"],null,null,0],["text","  "]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","      template block text\\n"]],"locals":[]}],"hasPartials":false}',
      'meta': {}
    }));
...
define('capstone_front_end/tests/integration/components/delete-docs-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {
  ...
  (0, _emberQunit.test)('it renders', function (assert) {
    ...
    this.render(Ember.HTMLBars.template({
      'id': 'hyLeEzu9',
      'block': '{"statements":[["append",["unknown",["delete-docs"]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
      'meta': {}
    }));
    ...
    this.render(Ember.HTMLBars.template({
      'id': 'HuFWhGp3',
      'block': '{"statements":[["text","\\n"],["block",["delete-docs"],null,null,0],["text","  "]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","      template block text\\n"]],"locals":[]}],"hasPartials":false}',
      'meta': {}
    }));
...
define('capstone_front_end/tests/integration/components/edit-doc-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {
  ...
  (0, _emberQunit.test)('it renders', function (assert) {
    ...
    this.render(Ember.HTMLBars.template({
      'id': '9CSfd3Lw',
      'block': '{"statements":[["append",["unknown",["edit-doc"]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
      'meta': {}
    }));
    ...
    this.render(Ember.HTMLBars.template({
      'id': 'ObQTTV1/',
      'block': '{"statements":[["text","\\n"],["block",["edit-doc"],null,null,0],["text","  "]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","      template block text\\n"]],"locals":[]}],"hasPartials":false}',
      'meta': {}
    }));
...
define('capstone_front_end/tests/integration/components/my-docs-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {
  ...
  (0, _emberQunit.test)('it renders', function (assert) {
    ...
    this.render(Ember.HTMLBars.template({
      'id': 'q7WkofaY',
      'block': '{"statements":[["append",["unknown",["my-docs"]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
      'meta': {}
    }));
    ...
    this.render(Ember.HTMLBars.template({
      'id': 'p44fU3u7',
      'block': '{"statements":[["text","\\n"],["block",["my-docs"],null,null,0],["text","  "]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","      template block text\\n"]],"locals":[]}],"hasPartials":false}',
      'meta': {}
    }));
...
define('capstone_front_end/tests/integration/components/new-document-test', ['exports', 'ember-qunit'], function (exports, _emberQunit) {
  ...
  (0, _emberQunit.test)('it renders', function (assert) {
    ...
    this.render(Ember.HTMLBars.template({
      'id': 'u+BjRiYa',
      'block': '{"statements":[["append",["unknown",["new-document"]],false]],"locals":[],"named":[],"yields":[],"blocks":[],"hasPartials":false}',
      'meta': {}
    }));
    ...
    this.render(Ember.HTMLBars.template({
      'id': 'nLOHrh5j',
      'block': '{"statements":[["text","\\n"],["block",["new-document"],null,null,0],["text","  "]],"locals":[],"named":[],"yields":[],"blocks":[{"statements":[["text","      template block text\\n"]],"locals":[]}],"hasPartials":false}',
      'meta': {}
    }));
...
define('capstone_front_end/tests/services/docs.jshint.lint-test', [], function () {
  ...
  QUnit.test('should pass jshint', function (assert) {
    assert.expect(1);
    assert.ok(false, 'services/docs.js should pass jshint.\nservices/docs.js: line 3, col 39, Missing semicolon.\nservices/docs.js: line 4, col 36, Missing semicolon.\nservices/docs.js: line 13, col 34, Missing semicolon.\nservices/docs.js: line 14, col 44, Missing semicolon.\nservices/docs.js: line 16, col 40, Missing semicolon.\nservices/docs.js: line 27, col 26, Missing semicolon.\nservices/docs.js: line 28, col 56, Missing semicolon.\nservices/docs.js: line 30, col 57, Missing semicolon.\nservices/docs.js: line 32, col 40, Missing semicolon.\nservices/docs.js: line 33, col 7, Missing semicolon.\nservices/docs.js: line 37, col 34, Missing semicolon.\nservices/docs.js: line 38, col 40, Missing semicolon.\nservices/docs.js: line 39, col 36, Missing semicolon.\nservices/docs.js: line 48, col 7, Missing semicolon.\nservices/docs.js: line 55, col 37, Missing semicolon.\nservices/docs.js: line 57, col 26, Missing semicolon.\nservices/docs.js: line 58, col 9, Missing semicolon.\nservices/docs.js: line 62, col 40, Missing semicolon.\nservices/docs.js: line 70, col 43, Missing semicolon.\nservices/docs.js: line 71, col 7, Missing semicolon.\nservices/docs.js: line 62, col 9, \'id\' is defined but never used.\nservices/docs.js: line 75, col 72, Missing semicolon.\nservices/docs.js: line 88, col 35, Missing semicolon.\nservices/docs.js: line 92, col 43, Missing semicolon.\nservices/docs.js: line 93, col 37, Missing semicolon.\nservices/docs.js: line 94, col 48, Missing semicolon.\nservices/docs.js: line 96, col 42, Missing semicolon.\nservices/docs.js: line 87, col 12, \'result\' is defined but never used.\nservices/docs.js: line 97, col 7, Missing semicolon.\nservices/docs.js: line 32, col 7, \'$\' is not defined.\nservices/docs.js: line 39, col 5, \'$\' is not defined.\nservices/docs.js: line 94, col 9, \'$\' is not defined.\nservices/docs.js: line 57, col 9, \'docsRoute\' is not defined.\nservices/docs.js: line 3, col 8, \'storage\' is defined but never used.\nservices/docs.js: line 4, col 8, \'Docs\' is defined but never used.\n\n35 errors');
  });
});
...
define('capstone_front_end/tests/test-helper', ['exports', 'capstone_front_end/tests/helpers/resolver', 'capstone_front_end/tests/helpers/flash-message', 'ember-qunit'], function (exports, _capstone_front_endTestsHelpersResolver, _capstone_front_endTestsHelpersFlashMessage, _emberQunit) {

  (0, _emberQunit.setResolver)(_capstone_front_endTestsHelpersResolver['default']);
});
...
define('capstone_front_end/tests/unit/initializers/text-field-test', ['exports', 'ember', 'capstone_front_end/initializers/text-field', 'qunit'], function (exports, _ember, _capstone_front_endInitializersTextField, _qunit) {
  ...
  (0, _qunit.test)('it works', function (assert) {
    _capstone_front_endInitializersTextField['default'].initialize(application);
