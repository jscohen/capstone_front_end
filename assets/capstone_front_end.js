  ...
  exports['default'] = _ember['default'].Component.extend({
    ...
    actions: {
      saveDoc: function saveDoc(id) {
        var input = $('#' + id + '.textToTranslate').val();
...
if (!runningTests) {
  require("capstone_front_end/app")["default"].create({"name":"capstone_front_end","version":"0.0.0+499a659c"});
}
